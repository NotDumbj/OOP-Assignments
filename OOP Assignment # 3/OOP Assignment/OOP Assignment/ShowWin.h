...
namespace OOPAssignment {
	...
	public: System::Windows::Forms::DataGridView^ showbox;
	public:
	public:
	protected:
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->showbox = (gcnew System::Windows::Forms::DataGridView());
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->showbox))->BeginInit();
			this->SuspendLayout();
			// 
			// button1
			// 
			...
			this->showbox->Location = System::Drawing::Point(81, 24);
			this->showbox->Name = L"showbox";
			this->showbox->Size = System::Drawing::Size(823, 444);
			...
			this->Name = L"ShowWin";
			this->Text = L"ShowWin";
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->showbox))->EndInit();
